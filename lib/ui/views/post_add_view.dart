...
class PostAddView extends StatefulWidget {
  ...
  PostAddView({required this.isImportant});
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
            ...
            actions: [
              IconButton(
                  onPressed: isPost == true
                      ? () async {
                          var snapshot =
                              await userProvider.getStaffById(user!.uid);
                          postProvider
                              .addPosts(Posts(
                                  post: _postField.text,
                                  posterId: user!.uid,
        ...
        body: Container(
          ...
          child: TextFormField(
            ...
            autofillHints: const [
              ...
              "whats going on at the office today"
            ],
            decoration: InputDecoration(hintText: "What is going on?"),
          ),
        ));
  }
}
